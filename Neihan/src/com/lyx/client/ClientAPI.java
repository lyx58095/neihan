...
public class ClientAPI {
	 ...
	 * @param minTime 用于分页加载数据，或者是下拉刷新时用，代表的上一次服务器返回的时间信息
	 ...
	 */
	public static void getList(RequestQueue queue, int categoryType, int itemCount, long minTime, Response.Listener<String> responseListener) {
		// 测试内涵段子列表接口，获取文本列表
